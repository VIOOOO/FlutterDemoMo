...
// 列表下拉刷新
class ListViewDemoRefresh extends StatefulWidget {
  ListViewDemoRefresh({Key key}) : super(key: key);

  @override
  _ListViewDemoRefreshState createState() => _ListViewDemoRefreshState();
}

class _ListViewDemoRefreshState extends State<ListViewDemoRefresh> {
  // 动态类型 简单列表
